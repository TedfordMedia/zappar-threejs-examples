...
function initialize() {
    ...
    client = Object.assign(Object.assign({}, c.impl), { camera_default_device_id: userFacing => userFacing ? camera_source_1.CameraSource.USER_DEFAULT_DEVICE_ID : camera_source_1.CameraSource.DEFAULT_DEVICE_ID, camera_source_create: (p, deviceId) => camera_source_1.CameraSource.create(p, deviceId), camera_source_destroy: cam => { var _a; return (_a = camera_source_1.CameraSource.get(cam)) === null || _a === void 0 ? void 0 : _a.destroy(); }, camera_source_pause: cam => { var _a; return (_a = camera_source_1.CameraSource.get(cam)) === null || _a === void 0 ? void 0 : _a.pause(); }, camera_source_start: cam => { var _a; return (_a = camera_source_1.CameraSource.get(cam)) === null || _a === void 0 ? void 0 : _a.start(); }, pipeline_create: () => pipeline_1.Pipeline.create(c.impl, worker_client_1.messageManager), pipeline_frame_update: (p) => { var _a; return (_a = pipeline_1.Pipeline.get(p)) === null || _a === void 0 ? void 0 : _a.frameUpdate(c); }, pipeline_camera_frame_draw_gl: (pipeline, screenWidth, screenHeight, mirror) => {
            ...
            if (!obj) {
                console.log("Warning: attempting to call draw_face on a destroyed zappar_face_mesh_t");
            ...
            if (!obj) {
                console.log("Warning: attempting to call face_mesh_indices on a destroyed zappar_face_mesh_t");
                return new Uint16Array();
            }
            ...
            let obj = facemesh_1.getFaceMesh(m);
            if (!obj) {
                console.log("Warning: attempting to call face_mesh_indices_size on a destroyed zappar_face_mesh_t");
                return 0;
            }
            ...
            let obj = facemesh_1.getFaceMesh(m);
            if (!obj) {
                console.log("Warning: attempting to call face_mesh_uvs on a destroyed zappar_face_mesh_t");
            ...
            let obj = facemesh_1.getFaceMesh(m);
            if (!obj) {
                console.log("Warning: attempting to call face_mesh_uvs_size on a destroyed zappar_face_mesh_t");
                return 0;
            }
            ...
            let obj = facemesh_1.getFaceMesh(m);
            if (!obj) {
                console.log("Warning: attempting to call face_mesh_vertices on a destroyed zappar_face_mesh_t");
                return new Float32Array();
            }
            ...
            let obj = facemesh_1.getFaceMesh(m);
            if (!obj) {
                console.log("Warning: attempting to call face_mesh_vertices_size on a destroyed zappar_face_mesh_t");
                return 0;
            }
            ...
            let obj = facemesh_1.getFaceMesh(m);
            if (!obj) {
                console.log("Warning: attempting to call face_mesh_normals on a destroyed zappar_face_mesh_t");
                return new Float32Array();
            }
            ...
            let obj = facemesh_1.getFaceMesh(m);
            if (!obj) {
                console.log("Warning: attempting to call face_mesh_normals_size on a destroyed zappar_face_mesh_t");
                return 0;
            }
            ...
            let obj = facemesh_1.getFaceMesh(m);
            if (!obj) {
                console.log("Warning: attempting to call face_mesh_load_from_memory on a destroyed zappar_face_mesh_t");
                return;
            }
            ...
            let obj = facemesh_1.getFaceMesh(m);
            if (!obj) {
                console.log("Warning: attempting to call face_mesh_update on a destroyed zappar_face_mesh_t");
                return;
            }
            ...
            let obj = facemesh_1.getFaceMesh(m);
            if (!obj) {
                console.log("Warning: attempting to call face_mesh_load_default on a destroyed zappar_face_mesh_t");
                return;
            }
            ...
            let obj = facemesh_1.getFaceMesh(m);
            if (!obj) {
                console.log("Warning: attempting to call face_mesh_load_default_face on a destroyed zappar_face_mesh_t");
                return;
            }
            let url = require("file-loader!./face_mesh_face_model.zbin").default;
            let req = yield fetch(url);
            ...
            let obj = facemesh_1.getFaceMesh(m);
            if (!obj) {
                console.log("Warning: attempting to call face_mesh_load_default_full_head_simplified on a destroyed zappar_face_mesh_t");
                return;
            }
            let url = require("file-loader!./face_mesh_full_head_simplified_model.zbin").default;
            let req = yield fetch(url);
            ...
            if (!obj) {
                console.log("Warning: attempting to call face_landmark_update on a destroyed zappar_face_landmark_t");
                return;
            }
            obj.update(identity, expression, mirrored);
